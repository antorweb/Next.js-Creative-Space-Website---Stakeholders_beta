  ...
  return (
    ...
    <section id='contact' >
        <div className="container">
            ...
            <div className='w-[648px] h-[800px] py-[48px]  px-[32px] mt-[127px] shadow rounded-[16px]'>
                ...
                <div className='my-[24px]'>
                    ...
                    <textarea className='w-[580px] h-[124px] mt-[8px] text-[14px] font-normal font-main text-[#4A5565] pt-[16px] px-[16px]  bg-[#F3F3F5]  rounded-[16px]' name="" id="textInput" placeholder='Tell us about your project...'></textarea>
            ...
            <div className='mt-[194px]'>
                ...
                <div>
                    ...
                    <div className='w-[536px] mt-[24px]'><h4 className='text-[18px] font-normal font-main text-[#4A5565]'>Have questions about our services or want to discuss a project? We're here to help. Contact us through any of the methods below and our team will respond as soon as possible.</h4></div>

                </div>


<div className='mt-[62px] flex flex-col gap-[24px] mb-[48px]'>
