        ...
        <div id="bannerContain" className=" py-20 ">
          <div className="container">
            ...
            <div className="text-center flex flex-col  justify-center items-center">
              ...
              <h1 className="text-[64px] font-bold font-main my-[16px] text-white">Building the Future, Today</h1>
              ...
              <div className="flex items-center gap-4 mt-10">
                ...
                <button className="w-[154px] text-[14px] font-medium font-main text-white flex justify-center items-center gap-[10px] bg-[#2E7D32] py-[16px] rounded-full hover:bg-white hover:border-[#2E7D32] hover:text-[#2E7D32] duration-400">Get Started <HiArrowRight /></button>
              </div>
